using System;
using Task_3._1.Program.Products.Basic;
using Task_3._1.Program.Interfaces;
...
namespace Task_3._1.Program.Products
{
            ...
            IComparable<VegetableAndDressing>
    {
        ...
        {
            double kcalOfProteins = value.GetProteins() / MASS_FRACTION_GRAMS * weight * ENERGY_KCAL_COUNT_IN_ONE_GRAM_OF_PROTEINS;
            double kcalOfFats = value.GetFats() / MASS_FRACTION_GRAMS * weight * ENERGY_KCAL_COUNT_IN_ONE_GRAM_OF_FATS;
            double kcalOfCarbohydrates = value.GetCarbohydrates() / MASS_FRACTION_GRAMS * weight * ENERGY_KCAL_COUNT_IN_ONE_GRAM_OF_CARBOHYDRAES;
